...
pub fn view() {
  html.p(
    ...
    [
      ...
      element.text(
        "Seeing Apple's malevolence for the umpteenth time, I reflected again on why I switched back to iOS to begin with. I don't think I had much of a reason apart from wanting to see what iOS on a phone after so long (and the fact that my Android broke ( ͡° ʖ̯ ͡°)). I miss being excited by hardware technology, growing up with the rapid improvement of the first half of the 2010s. It seems like very little has changed in the world of consumer technology since around 2017. Sure, things get faster, but to what end? I think the laman was satisfied long ago, and even I've been disinterested for a while apart from foldables and Apple silicon. "
      ),
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
      element.text(
        "I hate that companies chase market trends and profitability above all else. The "
      ),
      styling.href_text("https://www.youtube.com/watch?v=FJgTKx-rg18", "enthusiast trap"),
      element.text(
      ...
      element.text(" to tell manufacturers not to disregard us, but alas, this has borne no fruit thus far. "),
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
      element.text(
      ...
      styling.href_text("https://www.motortrend.com/features/why-americas-roads-keep-getting-deadlier-safety-research/", "save as many lives as small cars"),
      element.text(
