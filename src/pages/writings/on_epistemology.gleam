...
fn view() {
  html.p([attribute.class("center"), attribute.style([#("text-align", "justify")])], [
    ...
    html.ul(
      ...
      [
        html.li([], [element.text("connectives \\(\\lnot\\), \\(\\land\\), \\(\\lor\\), \\(\\smp\\), and \\(\\sff\\);")]),
        html.li([], [element.text("free variable symbols \\(u\\), \\(v\\), \\(w\\), \\(u_1\\),…;")]),
        html.li([], [element.text("bound variable symbols \\(x\\), \\(y\\), \\(z\\), \\(x_1\\),…;")]),
        html.li([], [element.text("quantifiers \\(\\forall\\) and \\(\\exists\\);")]),
        html.li([], [
        ...
        html.li([], [element.text("constant symbols \\(a\\), \\(b\\), \\(c\\), \\(a_1\\),…;")]),
        html.li([], [element.text("relation symbols \\(F\\), \\(G\\), \\(H\\), \\(P\\), \\(F_1\\),…;")]),
        html.li([], [element.text("function symbols \\(f\\), \\(g\\), \\(h\\), \\(f_1\\),…; and")]),
        html.li([], [element.text("an (optional) equality binary relation \\(\\approx\\).")])
      ],
    ),
    element.text(
      "
    ...
    html.div(
      ...
      element.text("Proving that something holds for all \\(x\\) proves that it holds for any arbitrary term \\(t\\) "),
    ...
    styling.href_text("https://en.wikipedia.org/wiki/Resolution_(logic)", "Resolution"),
    element.text(
    ...
    styling.i("these foundations exist to describe existing systems, not the other way around. "),
    element.text(
