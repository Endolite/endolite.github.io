...
pub fn view() {
  html.p([attribute.class("center"), attribute.style([#("text-align", "justify")])], [
    ...
    html.hr([attribute.style([#("margin-top", "0.5em"), #("margin-bottom", "0.5em")])]),
        ...
        element.text(", painting a picture of a Flint resident's embrace of emptiness. Its instrumentation is fittingly sparse, with accompaniment mostly coming from piano and heavily reverbed trumpet. The latter instrument builds with repetition of the lyric "),
        html.q([], [element.text("Even if I died alone")]),
        element.text(" to express resignation to and eventual proclamation of this line."),
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
      ...
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
        ...
        element.text(" is perhaps the most direct look at reality, taking a more detached and cynical tone in observance of the ruin wrought on Detroit through the intense proliferation and stark abandonment of industry, returning to the upbeat 5/4 of "),
      ...
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
        ...
        element.text(" nonetheless searches again for divine comfort and judgement while the narrator questions the relationship between their own perception of righteousness and that of God's ("),
      ...
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
        ...
        element.text("), quelling the prior doubt by asserting that all is as ordained by universal, divine love, and serving as a cathartic epilogue of sorts to the album. Repeating this like a mantra, this expresses an internal resolution and restored faith, despite it all."),
    html.hr([attribute.style([#("margin-top", "0.5em"), #("margin-bottom", "0.5em")])]),
        html.img([
          attribute.src("
      ...
      html.br([attribute.style([#("margin-bottom", "0.5em")])]),
        ...
        element.text("), being told from the perspective of a truly benevolent deity tending to humanity as a parent ("),
